...
# Bundle libraries
/usr/local/opt/qt-lite/bin/macdeployqt MoonPlayer.app -libpath=/usr/local/opt/qt/lib -qmldir=src/qml/ -executable=MoonPlayer.app/Contents/MacOS/moonplayer-hlsdl
