...
export PATH=/c/Qt/6.2.3/msvc2019_64/bin:/c/Qt/5.15.2/msvc2019_64/bin:$PATH
...
# Bundle ffmpeg
curl -Lo ffmpeg.7z https://www.gyan.dev/ffmpeg/builds/packages/ffmpeg-4.4.1-essentials_build.7z
