...
# Bundle ffmpeg
curl -Lo ffmpeg.7z https://www.gyan.dev/ffmpeg/builds/packages/ffmpeg-5.1-essentials_build.7z
7z e ffmpeg.7z -omoonplayer ffmpeg-5.1-essentials_build/bin/ffmpeg.exe
