...
unix:!macx {
    usr_share.files += plugins moonplayer_*.qm Version you_get_patched.py upgrade-you-get.sh
...
macx {
    ...
    RESFILES.files = upgrade-you-get.sh you_get_patched.py plugins Version
