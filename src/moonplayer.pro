...
unix:!macx {
    usr_share.files += plugins unblockcn moonplayer_*.qm Version you_get_patched.py upgrade-you-get.sh upgrade-ykdl.sh upgrade-parsers.sh
...
macx {
    ...
    RESFILES.files = upgrade-you-get.sh upgrade-ykdl.sh upgrade-parsers.sh you_get_patched.py plugins unblockcn Version
